...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="assets/assets/plugins/custom/prismjs/prismjs.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="assets/assets/assets/media/logos/logo-letter-9.png" class="max-h-30px" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
																		...
																		<div class="card card-custom gutter-b">
																			...
																			<div class="card-body">
																				...
																				<div class="example">
																					...
																					<code>white|primary|secondary|success|info|warning|danger|light|dark</code>.</p>
																		...
																		<div class="card card-custom gutter-b">
																			...
																			<div class="card-body">
																				...
																				<div class="example">
																					...
																					<code>&lt;a&gt;</code>or
																					<code>&lt;input&gt;</code>elements (though some browsers may render slightly different).</p>
																					<div class="example-preview">
																		...
																		<div class="card card-custom gutter-b">
																			...
																			<div class="card-body">
																				...
																				<div class="example">
																					...
																					<code>.btn-outline-*</code>to remove all background images and colors on any button.</p>
																					<div class="example-preview">
																						<p>
																		...
																		<div class="card card-custom gutter-b">
																			...
																			<div class="card-body">
																				...
																				<div class="example mb-15">
																					...
																					<p>Buttons will appear pressed (with a darker background, darker border, and inset shadow) when active with
																					<code>.active</code>.</p>
																					<div class="example-preview">
																						<p>
																		...
																		<div class="card card-custom gutter-b">
																			...
																			<div class="card-body">
																				...
																				<div class="example mb-10">
																					<p>Bootstrap’s button styles can be applied to other elements, such as labels, to provide checkbox or radio style button toggling.</p>
																					<div class="example-preview">
																				...
																				<div class="example">
																					<div class="example-preview">
																						<div class="btn-group btn-group-toggle" data-toggle="buttons">
																							<label class="btn btn-success active">
																							<input type="radio" name="options" id="option1" checked="checked" />Active</label>
																	...
																	<div class="col-xl-6">
																		...
																		<div class="card card-custom gutter-b">
																			...
																			<div class="card-body">
																				...
																				<div class="example">
																					<p>Use
																					<code>btn-light-{color}</code>class to have a custom button style with a lighter background color and dark font color.</p>
																					<div class="example-preview">
								                        ...
								                        &lt;a href="#" class="btn btn-hover-bg-dark btn-text-dark btn-hover-text-white border-0 font-weight-bold mr-2"&gt;Dark&lt;/a&gt;
																		...
																		<div class="card card-custom gutter-b">
																			...
																			<div class="card-body">
																				...
																				<div class="example">
																					<p>Use
																					<code>btn-transparent-{color}</code>class to have a custom button style with a transparent background color.</p>
																					<div class="example-preview">
								                        ...
								                        &lt;/div&gt;
																		...
																		<div class="card card-custom gutter-b">
																			...
																			<div class="card-body">
																				...
																				<div class="example">
																					<p>Use
																					<code>btn-hover-transparent-{color}</code>class to have a custom button style with a transparent hover background color.</p>
																					<div class="example-preview">
																						<div class="d-flex align-items-center p-4 bg-dark">
																		...
																		<div class="card card-custom gutter-b">
																			...
																			<div class="card-body">
																				...
																				<div class="example">
																					...
																					<code>white|primary|secondary|success|info|warning|danger|light|dark|dark-75|dark-50|dark-25|muted</code>.</p>
																					<div class="example-preview">
																						<a href="#" class="btn btn-light btn-text-success btn-hover-text-success font-weight-bold mr-2">Success</a>
																						<a href="#" class="btn btn-light btn-text-primary btn-hover-text-primary font-weight-bold mr-2">Primary</a>
																						<a href="#" class="btn btn-light btn-text-danger btn-hover-text-danger font-weight-bold mr-2">Danger</a>
																						<a href="#" class="btn btn-light btn-text-warning btn-hover-text-dark-50 font-weight-bold mr-2">Warning</a>
																						<a href="#" class="btn btn-light btn-text-dark btn-hover-text-dark font-weight-bold mr-2">Dark</a>
																					</div>
																					<div class="example-code">
																						<span class="example-copy" data-toggle="tooltip" title="Copy code"></span>
																						<div class="example-highlight">
								                        ...
								                        &lt;a href="#" class="btn btn-light btn-text-dark btn-hover-text-dark font-weight-bold"&gt;Dark&lt;/a&gt;</code>
																		...
																		<div class="card card-custom gutter-b">
																			...
																			<div class="card-body">
																				...
																				<div class="example">
																					<p>Use
																					<code>btn-hover-{color}</code>class to have a custom hover color for your buttons.</p>
																					<div class="example-preview">
																						<a href="#" class="btn btn-light btn-hover-success font-weight-bold mr-2">Success</a>
																						<a href="#" class="btn btn-light btn-hover-primary font-weight-bold mr-2">Primary</a>
																						<a href="#" class="btn btn-light btn-hover-danger font-weight-bold mr-2">Danger</a>
																						<a href="#" class="btn btn-light btn-hover-warning font-weight-bold mr-2">Warning</a>
																		...
																		<div class="card card-custom gutter-b">
																			...
																			<div class="card-body">
																				...
																				<div class="example mb-15">
																					...
																					<code>btn-icon-{font-color}</code>classes to set custom color for button texts and icons where
																					<code>{font-color}</code>can be
																					<code>white|primary|secondary|success|info|warning|danger|light|dark|dark-75|dark-50|dark-25|muted</code>.</p>
																					<div class="example-preview">
																						<p>
																						...
																						<p>
																							<a href="#" class="btn btn-text-dark-50 btn-icon-primary btn-hover-icon-danger font-weight-bold btn-hover-bg-light mr-3">
																							<i class="flaticon2-pie-chart"></i>Button</a>
																							<a href="#" class="btn btn-text-dark-50 btn-icon-primary btn-hover-icon-success font-weight-bold btn-hover-bg-light mr-3">
																							<i class="flaticon2-graph-1"></i>Button</a>
																							<a href="#" class="btn btn-text-dark-50 btn-icon-primary btn-hover-icon-warning font-weight-bold btn-hover-bg-light">
																							<span class="svg-icon">
																								<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg-->
																								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																		...
																		<div class="card card-custom gutter-b">
																			...
																			<div class="card-body">
																				...
																				<div class="example mb-15">
																					...
																					<code>src\sass\components\_variables.bootstrap.scss</code>.</p>
																					<div class="example-preview">
																						<p>
		...
		<script src="assets/assets/plugins/custom/prismjs/prismjs.bundle.js"></script>
		...
		<script src="assets/assets/js/pages/widgets.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>